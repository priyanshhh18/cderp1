...
import { Upload, User, Save, Eye, Image as ImageIcon, X, Plus, Hash, Calendar, Camera, Edit, Tag, Trash2, Bold, Italic, Underline, Link, AlignLeft, AlignCenter, AlignRight, AlignJustify, List, Type, Palette, Code, Quote, Video, Indent, Outdent, BookOpen } from 'lucide-react';
...
export default function CreateBlogPost({
  ...
  // ✅ NEW: Common course image state
  const [commonCourseImage, setCommonCourseImage] = useState({
    file: null,
    preview: null
  });
...
quill.setSelection(index + linkText.length, 0);
  ...
  const handleDragBanner = (e) => {
    e.preventDefault();
    e.stopPropagation();
    if (e.type === 'dragenter' || e.type === 'dragover') setDragActiveBanner(true);
    else if (e.type === 'dragleave') setDragActiveBanner(false);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        const validCourseSections = (formData.courseSections || []).filter(
            s => s.name?.trim() && s.description?.trim() && s.url?.trim()
        );
        ...
        if (!isEditMode) {
            setFormData({
                title: '', urlSlug: '', content: '', category: '',
                subcategory: 'Article', authorName: '', status: 'None',
                blogImage: null, bannerImage: null, tags: [], courseSections: []
            });
            setPreviewImage(null);
            setPreviewBanner(null);
            setExistingImageUrl(null);
              ...
              <form id="blog-form" onSubmit={handleSubmit} className="p-4 md:p-6 lg:p-8 space-y-6 pb-28 sm:pb-0">
                ...
                <div className="group">
                  ...
                  <div className="sticky top-4 z-30 bg-white/95 backdrop-blur-sm border border-gray-200 rounded-lg shadow-lg mb-2">
                    <div className="flex flex-wrap items-center p-3 gap-2 overflow-x-auto">
                      ...
                      <button
                        ...
                        className="p-2.5 hover:bg-gray-100 active:bg-gray-200 rounded transition-colors font-bold text-sm border border-transparent hover:border-gray-300"
                        title="Bold (Ctrl+B)"
                      >
                      ...
                      <button
                        ...
                        className="p-2.5 hover:bg-gray-100 active:bg-gray-200 rounded transition-colors text-sm border border-transparent hover:border-gray-300"
                        title="Italic (Ctrl+I)"
                      >
                      ...
                      <button
                        type="button"
                        onClick={() => applyQuickFormat('strike')}
                        className="p-2.5 hover:bg-gray-100 active:bg-gray-200 rounded transition-colors text-sm border border-transparent hover:border-gray-300 line-through font-bold"
                        title="Strikethrough"
                      >
                        S
                      </button>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-10 h-10 border border-gray-300 rounded cursor-pointer bg-white"
                          title="Text Color"
                        />
                      ...
                      <div className="relative">
                        <input
                          type="color"
                          onChange={(e) => applyQuickFormat('background', e.target.value)}
                      ...
                      <button
                        type="button"
                        onClick={() => applyQuickFormat('align', '')}
                        className="p-2.5 hover:bg-gray-100 active:bg-gray-200 rounded transition-colors border border-transparent hover:border-gray-300"
                        title="Align Left"
                      >
                      ...
                      <button
                        type="button"
                        onClick={() => applyQuickFormat('align', 'center')}
                        className="p-2.5 hover:bg-gray-100 active:bg-gray-200 rounded transition-colors border border-transparent hover:border-gray-300"
                        title="Align Center"
                      >
                      ...
                      <button
                        type="button"
                        onClick={() => applyQuickFormat('align', 'right')}
                        className="p-2.5 hover:bg-gray-100 active:bg-gray-200 rounded transition-colors border border-transparent hover:border-gray-300"
                        title="Align Right"
                      >
                      ...
                      <button
                        type="button"
                        onClick={() => applyQuickFormat('align', 'justify')}
                        className="p-2.5 hover:bg-gray-100 active:bg-gray-200 rounded transition-colors border border-transparent hover:border-gray-300"
                        title="Justify"
                      >
                      ...
                      <button
                        type="button"
                        onClick={() => applyQuickFormat('list', 'bullet')}
                        className="p-2.5 hover:bg-gray-100 active:bg-gray-200 rounded transition-colors border border-transparent hover:border-gray-300"
                        title="Bullet List"
                      >
                      ...
                      <button
                        type="button"
                        onClick={() => applyQuickFormat('list', 'ordered')}
                        className="p-2.5 hover:bg-gray-100 active:bg-gray-200 rounded transition-colors font-mono text-sm font-bold border border-transparent hover:border-gray-300"
                        title="Numbered List"
                      >
                        1.
                      </button>
                      ...
                      <button
                        type="button"
                        onClick={() => applyQuickFormat('indent', '-1')}
                        className="p-2.5 hover:bg-gray-100 active:bg-gray-200 rounded transition-colors border border-transparent hover:border-gray-300"
                      ...
                      <button
                        type="button"
                        onClick={() => insertQuickContent('link')}
                        className="p-2.5 hover:bg-gray-100 active:bg-gray-200 rounded transition-colors border border-transparent hover:border-gray-300"
                        title="Insert Link"
                      >
                      ...
                      <button
                        type="button"
                        onClick={() => insertQuickContent('image')}
                        className="p-2.5 hover:bg-gray-100 active:bg-gray-200 rounded transition-colors border border-transparent hover:border-gray-300"
                        title="Insert Image"
                      >
                      ...
                      <button
                        type="button"
                        onClick={() => insertQuickContent('video')}
                        className="p-2.5 hover:bg-gray-100 active:bg-gray-200 rounded transition-colors border border-transparent hover:border-gray-300"
                        title="Insert Video"
                      >
                      ...
                      <button
                        type="button"
                        onClick={() => applyQuickFormat('blockquote', true)}
                        className="p-2.5 hover:bg-gray-100 active:bg-gray-200 rounded transition-colors text-lg font-bold border border-transparent hover:border-gray-300"
                        title="Blockquote"
                      >
                      ...
                      <button
                        type="button"
                        onClick={() => applyQuickFormat('code-block', true)}
                        className="p-2.5 hover:bg-gray-100 active:bg-gray-200 rounded transition-colors border border-transparent hover:border-gray-300"
                        title="Code Block"
                      >
                      ...
                      <button
                        ...
                        className="p-2.5 hover:bg-red-100 active:bg-red-200 rounded transition-colors text-red-600 border border-transparent hover:border-red-300"
                      ...
                      <button
                        ...
                        className="p-2.5 hover:bg-orange-100 active:bg-orange-200 rounded transition-colors text-orange-600 font-bold text-sm border border-transparent hover:border-orange-300"
                  ...
                  <p id="content-help" className={helpText}>
                    <strong>✨ Professional Rich Text Editor:</strong> Sticky toolbar with all formatting tools always visible!
                    <br />
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div
                        className={`relative w-full min-h-[200px] rounded-xl p-4 flex items-center justify-center bg-white shadow-sm
                        border-2 border-dashed ${dragActive ? 'border-blue-500 bg-blue-50' : 'border-gray-200'}
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Main blog cover image displayed in listings
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <div
                        className={`relative w-full min-h-[200px] rounded-xl p-4 flex items-center justify-center bg-white shadow-sm
                        border-2 border-dashed ${dragActiveBanner ? 'border-green-500 bg-green-50' : 'border-gray-200'}
                        ring-1 ring-gray-200 focus-within:ring-2 focus-within:ring-green-600 focus-within:ring-offset-2
                        transition-all`}
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Wide banner image for blog header/hero section
                      </p>
                    </div>
                  ...
                  <p className={helpText}>
                    <strong>Featured Image:</strong> Main cover image shown in blog listings and social shares.
                    <br />
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <label className={`${labelBase} flex items-center`}>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        <div className={`relative w-full aspect-[4/3] rounded-lg border-2 border-dashed ${
                          commonCourseImage.preview ? 'border-transparent' : 'border-blue-300 hover:border-blue-500'
                        } bg-blue-50 flex items-center justify-center overflow-hidden`}>
                          {commonCourseImage.preview ? (
                            <>
                              <img 
                                src={commonCourseImage.preview} 
                                alt="Common course preview" 
                          ...
                          {formData.courseSections.length > 0 && (
                            <div className="mt-3 pt-2 border-t border-blue-200">
                              <p className="text-xs text-blue-600">
                                {formData.courseSections.length} course(s) will receive this image
                              </p>
                            </div>
                          )}
                        </div>
                        ...
                        <div key={index} className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                          ...
                          <div className="space-y-3 md:flex md:space-x-4">
                            ...
                            <div className="w-full md:w-64 flex-shrink-0">
                              ...
                              <div 
                                className={`relative w-full aspect-[4/3] rounded-lg border-2 border-dashed ${
                                  section.imagePreview ? 'border-transparent' : 'border-gray-300 hover:border-blue-500'
                              ...
                              <p className="text-xs text-gray-500 mt-1 text-center">Recommended: 800×600px (4:3 ratio)</p>
                            </div>
                          </div>
                        </div>
                      ))}
                ...
                <div className="bg-gray-50 rounded-xl p-4 min-h-48 flex flex-col">
                  ...
                  {formData.tags.length > 0 && (
                    <div className="flex flex-wrap gap-1 mb-3">
                      {formData.tags.map((tag, index) => (
                        <span
                          key={index}
                          className="inline-flex items-center bg-gray-200 text-gray-700 text-xs px-2 py-1 rounded-md"
                        >
                          #{tag}
                        </span>
                      ))}
                  ...
                  <div 
                    ...
                    dangerouslySetInnerHTML={{
                      __html: formData.content || 'Your blog content preview will be displayed here as you type with full formatting, colors, images, and links...'
                    }}
                  />
