      ...
      <AnimatePresence mode="wait">
        ...
        >
          {typeof currentLogo === "string" ? (
            <div className="relative w-20 h-20 md:w-32 md:h-32 max-w-[80%] max-h-[80%]">
              <Image
                src={currentLogo}
...
function LogoCarousel({ columnCount = 2 }) {
  ...
  const allLogos = useMemo(
    () => [
      { name: "Apple", id: 1, img: "https://res.cloudinary.com/dubeuisom/image/upload/v1757051936/e1jcej7xqfpjgsk6qcnz_xqclvt.avif" },
      { name: "CEO Supabase", id: 2, img: "https://res.cloudinary.com/dubeuisom/image/upload/v1757051938/hz4k6yn9dhfesfep2jt6_d6nzdc.avif" },
      { name: "Vercel", id: 3, img: "https://res.cloudinary.com/drvug594q/image/upload/v1754119549/B_ur486e.avif" },
      { name: "Lowes", id: 4, img: "https://res.cloudinary.com/dubeuisom/image/upload/v1757051936/y6y8sxhxp0x0crjk7fku_mmgmah.avif" },
      { name: "Ally", id: 5, img: "https://res.cloudinary.com/dubeuisom/image/upload/v1757051938/fogwz81r2nwvjeflrsfx_hfrm4f.avif" },
      { name: "Pierre", id: 6, img: "https://res.cloudinary.com/drvug594q/image/upload/v1754119549/C_vsjkiy.avif" },
      { name: "BMW", id: 7, img: "https://res.cloudinary.com/drvug594q/image/upload/v1754119549/C_vsjkiy.avif"},
      { name: "Claude", id: 8, img: "https://res.cloudinary.com/drvug594q/image/upload/v1754119549/A_czofnz.avif" },
      { name: "Nextjs", id: 9, img: "https://res.cloudinary.com/drvug594q/image/upload/v1754119537/J_nek9z0.avif" },
      { name: "Tailwind", id: 10, img: "https://res.cloudinary.com/drvug594q/image/upload/v1754119537/K_vfcxtt.avif" },
      { name: "Upstash", id: 11, img: UpstashIcon },
      { name: "Typescript", id: 12, img: TypeScriptIcon },
      { name: "Stripe", id: 13, img: "https://res.cloudinary.com/drvug594q/image/upload/v1754119537/K_vfcxtt.avif" },
